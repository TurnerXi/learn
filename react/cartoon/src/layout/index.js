  ...
  render() {
    return (
      <HashRouter className="o-page-container">
        <Switch>
          <Route exact path="/main/:nest" component={Main}></Route>
        ...
        <div className="c-navbar">
          <ul className="c-navbar-list">
            <li><NavLink className="c-navbar-link" activeClassName="active" to="/main/recom"><i className="iconfont c-navbar-icon">&#xe6d7;</i><span className="c-navbar-title">首页</span></NavLink></li>
